...
app.registerExtension({
    name: "AngelosKar.ImageListScheduler",

    async beforeRegisterNodeDef(nodeType, nodeData, appInstance) {
        if (nodeData.name !== "AK_ImageListScheduler") return;
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            const resetBtn = this.addWidget("button", "🔄 Reset Counter", "reset", () => {
                ...
                api.fetchApi("/angeloskar/reset_image_list_counter", {
                    method: "POST",
                    ...
                    .then(data => {
                        ...
                        appInstance.graph.setDirtyCanvas(true);
                        console.log("[AK] Counter reset:", data.message);
